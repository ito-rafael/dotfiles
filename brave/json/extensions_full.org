...
#+end_src
*** Tab Session Manager
- link: https://chromewebstore.google.com/detail/tab-session-manager/iaiomicjabeggjcfkbimgmglanimpnae
- description: save and restore tabs.
#+begin_src js :noweb yes
...
#+end_src
*** Violentmonkey
- link: https://chromewebstore.google.com/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag
...
#+end_src
*** uBlock Origin Lite
- link: https://chromewebstore.google.com/detail/ddkjiahejlhfcafbddmgiahcphecmpfh
...
#+end_src
*** Save to Pocket
- link: https://chromewebstore.google.com/detail/save-to-pocket/niloccemoadcdkdjlinkgdfekeahmflj
