#+TITLE: Enable "Allow in Private" for Video Speed Controller
#+AUTHOR: Rafael Ito
#+PROPERTY: header-args :shebang "#!/usr/bin/env python3"
#+PROPERTY: header-args:python :tangle video-speed-controller_allow-in-private.py :tangle-mode (identity #o740)
