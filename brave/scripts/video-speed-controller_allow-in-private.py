...
"""
Automates toggling the "Allow in Private" permission for the Viedo Speed Controller extension.
Uses Selenium with a real user profile to pierce the Shadow DOM and physically click the toggle.
"""

EXTENSION_ID = "nffaoalbilbmmfgbnbgppjihopabppdk"  # Video Speed Controller
