...
#+begin_src css
#custom-mx-master3-mouse {
    color: lightgray;
}
#+end_src
*** Full
#+begin_src css
#custom-mx-master3-mouse.full {
}
#+end_src
*** Good
#+begin_src css
#custom-mx-master3-mouse.good {
}
#+end_src
*** Low
#+begin_src css
#custom-mx-master3-mouse.low {
    background: rgba(255, 255, 0, 0.5);
}
#+end_src
*** Critical
#+begin_src css
#custom-mx-master3-mouse.critical {
    background: rgba(255, 0, 0, 0.5);
}
#+end_src
*** Hover
#+begin_src css
#custom-mx-master3:hover {
    background: rgba(128, 128, 128, 0.5);
    transition: background 0.3s ease;
}
#+end_src
