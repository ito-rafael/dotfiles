...
"group/proton-vpn": {
    "orientation": "inherit",
    "modules": [
        "image#proton-vpn-icon",
        "custom/proton-vpn-script",
    ],
},
#+end_src
*** Icon
#+begin_src js
"image#proton-vpn-icon": {
    "exec": "~/.config/waybar/scripts/proton-vpn-icon.sh",
    "interval": 120,
    "size": 14,
    "on-click": "~/.config/waybar/scripts/proton-vpn-script.sh toggle &",
    "tooltip": true,
    "tooltip-format": "Proton VPN",
    "signal": 9,
},
#+end_src
*** Script
...
"custom/proton-vpn-script": {
    "return-type": "json",
    "exec": "~/.config/waybar/scripts/proton-vpn-script.sh status",
    "interval": 120,
    "on-click": "~/.config/waybar/scripts/proton-vpn-script.sh toggle &",
    "signal": 9,
},
