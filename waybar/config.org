...
"image#arch-news": {
    ...
    "exec": "informant check | awk '$3 != \"no\" {print \"/home/rafael/.config/waybar/icon/archlinux.png\"}'",
    "interval": 3600,
    "size": 16,
...
#+begin_src js
"custom/informant": {
    "exec": "informant check | awk '$3 != \"no\" { printf \"{\\\"text\\\": \\\"%s\\\", \\\"tooltip\\\": \\\"%s unread Arch News items!\\\"}\\n\", $3, $3 }'",
    "interval": 3600,
    "return-type": "json",
    "format": "{}",
    "on-click": "kitty -e informant read"
