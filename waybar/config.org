...
"custom/kmonad": {
    "return-type": "json",
    "exec": "~/.config/waybar/scripts/kmonad.sh monitor",
    "on-click": "~/.config/waybar/scripts/kmonad.sh toggle",
    "on-click-right": "~/.config/waybar/scripts/kmonad.sh stop",
    "on-click-middle": "~/.config/waybar/scripts/kmonad.sh restart",
    "format": " {} {icon} ",
    "format-icons": {
