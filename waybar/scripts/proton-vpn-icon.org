#+TITLE: Proton VPN Waybar displayer
#+AUTHOR: Rafael Ito
#+PROPERTY: header-args :tangle proton-vpn-icon.sh :shebang "#!/usr/bin/env bash"
#+DESCRIPTION: Waybar script to display the image for image#proton-vpn module
