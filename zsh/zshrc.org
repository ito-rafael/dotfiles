...
ssh() {
  # change the local terminal to the SSH theme
  kitty @ set-colors -a "$XDG_CONFIG_HOME/kitty/themes/ssh.conf"
  # run the actual SSH command (using kitten ssh)
  kitten ssh "$@"
  # revert back to your default theme when you disconnect
  #kitty @ set-colors -a "$XDG_CONFIG_HOME/kitty/themes/default.conf"
  kitty @ set-colors -a --reset
}
#+end_src
** journalctl
#+begin_src sh
...
alias wtm='watch grep -e Dirty -e Writeback /proc/meminfo'  # watch memory write
#+end_src
** Network
#+begin_src sh
...
alias cdpwi='cd $HOME/git/dotfiles/waybar/icon'
#+end_src
*** XDG_CONFIG_HOME
#+begin_src sh
...
alias cdwi='cd $XDG_CONFIG_HOME/waybar/icon'
...
** Distrobox
#+begin_src sh
function dbe() { distrobox enter $(docker ps | grep $1 | awk '{print $1}') -- ${2:-bash} }
...
zvm_after_init_commands+=(
    ...
    "bindkey -M vicmd 'e' vi-forward-word-end-skip-slash"
    # visual
    "bindkey -M visual 'b' vi-backward-word-skip-slash"
    "bindkey -M visual 'w' vi-forward-word-skip-slash"
    "bindkey -M visual 'e' vi-forward-word-end-skip-slash"
)
#+end_src
