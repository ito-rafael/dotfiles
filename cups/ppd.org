...
The =*.ppd= files should be placed in =/etc/cups/ppd/= directory.
* LBiC
** HP LaserJet P3005dn
#+begin_src conf :tangle HP-LaserJet-p3005.ppd
*PPD-Adobe: "4.3"
*%%%% PPD file for HP LaserJet p3005 with CUPS.
*%%%% Created by the CUPS PPD Compiler CUPS v2.4.16.
...
*Product: "(HP LaserJet p3005 Printer)"
*Product: "(HP LaserJet p3005d Printer)"
*Product: "(HP LaserJet p3005dn Printer)"
*Product: "(HP LaserJet p3005n Printer)"
*Product: "(HP LaserJet p3005x Printer)"
*Product: "(HP LaserJet p3005dtn Printer)"
*Manufacturer: "HP"
*ModelName: "HP LaserJet p3005"
*ShortNickName: "HP LaserJet p3005 hpijs"
*NickName: "HP LaserJet p3005 pcl3, hpcups 3.25.8"
...
*1284DeviceID: "MFG:Hewlett-Packard;MDL:hp laserjet p3005;DES:hp laserjet p3005;"
*cupsVersion: 2.4
*cupsModelNumber: 0
...
*% End of hp-laserjet_p3005-pcl3.ppd, 15362 bytes.
#+end_src
