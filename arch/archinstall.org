...
* User configuration
:PROPERTIES:
:header-args: :noweb-ref archinstall
:END:
#+begin_src js
{
#+end_src
...
** Network
*** DHCP
#+begin_src js :noweb-ref ip-dhcp
"network_config": {
  "type": "nm"
},
#+end_src
*** Static IP
#+begin_src js :noweb-ref ip-static
"network_config": {
  "type": "manual",
  "nics": [
    {
...
* Tangle :noexport:
** Static IP
#+begin_src conf :noweb yes :tangle archinstall.json
<<archinstall>>
<<ip-static>>
#+end_src
** DHCP
#+begin_src conf :noweb yes :tangle archinstall-dhcp.json
<<archinstall>>
<<ip-dhcp>>
#+end_src
* User credentials
