...
class AnsibleProvisionApp(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        # inject custom CSS for the smaller command preview font
        css_provider = Gtk.CssProvider()
        css_provider.load_from_data(b".small-cmd { font-size: 0.85em; }")
        ...
        # TOP GRID (For snug elements)
        self.top_grid = Gtk.Grid(row_spacing=15, column_spacing=12)
        self.top_grid.set_halign(Gtk.Align.CENTER)
        ...
        v_sep.set_margin_start(15)
        v_sep.set_margin_end(15)
        ...
        # A CenterBox naturally aligns elements to the Left, Center, and Right
        bottom_bar = Gtk.CenterBox(margin_top=10)

        # left: Mode Indicator
        self.mode_label = Gtk.Label(label="<b>NORMAL</b>", use_markup=True)
        bottom_bar.set_start_widget(self.mode_label)
        ...
        bottom_bar.set_center_widget(btn_box)
    ...
    def on_focus_changed(self, *args):
        ...
        if is_insert_mode:
            self.mode_label.set_markup("<b>INSERT</b>")
        else:
            self.mode_label.set_markup("<b>NORMAL</b>")
