...
** i3
**** Currency & superscript (terminal)
#+begin_src conf :noweb yes :noweb-ref i3-macro
...
#+end_src
**** Currency & superscript
#+begin_src conf :noweb-ref i3-macro
...
** Sway
**** Currency & superscript (terminal)
#+begin_src conf :noweb yes :noweb-ref sway-macro
  - name: miscellaneous text - currency & superscript (terminal)
    application:
      only: [kitty, dropdown_terminal, dropdown_python]
    remap:
      # currency
      Alt_R-e:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"€\"  | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
      Alt_R-p:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"£\"  | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
      Alt_R-y:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"￥\" | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
      Alt_R-r:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"₽\"  | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
      # superscript
      Alt_R-a:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"ª\"  | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
      Alt_R-o:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"º\"  | wl-copy && ydotool key 29:1 42:1 47:1 47:0 42:0 29:0"] }
#+end_src
**** Currency & superscript
#+begin_src conf :noweb-ref sway-macro
  - name: miscellaneous text - currency & superscript
    remap:
      # currency
      Alt_R-e:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"€\"  | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
      Alt_R-p:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"£\"  | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
      Alt_R-y:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"￥\" | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
      Alt_R-r:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"₽\"  | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
      # superscript
      Alt_R-a:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"ª\"  | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
      Alt_R-o:  { launch: ["bash", "-c", "sleep 0.1 && echo -n \"º\"  | wl-copy && ydotool key 29:1 47:1 47:0 29:0"] }
#+end_src
** Emote navigation
