...
**** Fix next line
#+begin_src emacs-lisp
;; intercept evil-next-visual-line
(defun efs/magit-logical-next-line (orig-fun &rest args)
  "Force logical line movement in Magit buffers, otherwise use visual."
  (if (derived-mode-p 'magit-mode)
      (apply #'evil-next-line args)
    (apply orig-fun args)))
(advice-add 'evil-next-visual-line :around #'efs/magit-logical-next-line)
#+end_src
**** Fix previous line
#+begin_src emacs-lisp
;; intercept evil-previous-visual-line
(defun efs/magit-logical-previous-line (orig-fun &rest args)
  "Force logical line movement in Magit buffers, otherwise use visual."
  (if (derived-mode-p 'magit-mode)
      (apply #'evil-previous-line args)
    (apply orig-fun args)))
(advice-add 'evil-previous-visual-line :around #'efs/magit-logical-previous-line)
#+end_src
** Forge
