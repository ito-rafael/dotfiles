#+TITLE: Script to clean up Brave Origin running via Distrobox
#+AUTHOR: Rafael Ito
#+PROPERTY: header-args :shebang "#!/usr/bin/env bash"
#+PROPERTY: header-args:sh :tangle cleanup.sh :tangle-mode o744
...
#+begin_src sh
echo -e '\n********************\nEnabling Developer Mode\n********************'
distrobox enter brave-origin-beta -- python3 /usr/local/bin/developer_mode.py
#+end_src
* Surfingkeys
** Allow User Scripts
#+begin_src sh
...
distrobox enter brave-origin-beta -- distrobox-export --app brave-origin-beta
#+end_src
