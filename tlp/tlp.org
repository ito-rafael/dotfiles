#+TITLE: TLP configuration
#+AUTHOR: Rafael Ito
#+PROPERTY: header-args :tangle tlp.conf
#+DESCRIPTION: TLP user configuration file
...
- [[#general][General]]
- [[#profiles][Profiles]]
- [[#disks-and-file-system][Disks and File System]]
  - [[#file-system][File System]]
  - [[#disks-and-ahci][Disks and AHCI]]
  - [[#media-bay][Media Bay]]
- [[#cpu][CPU]]
- [[#platform-profile-and-suspend][Platform Profile and Suspend]]
- [[#gpu-and-graphics][GPU and Graphics]]
...
- [[#tlp-rdw-radio-device-wizard][TLP-RDW (Radio Device Wizard)]]

* General
#+begin_src conf
# ----------------------------------------------------------------------------
# /etc/tlp.conf - TLP user configuration (version 1.10.1)
