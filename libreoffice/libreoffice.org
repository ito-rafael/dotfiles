...
|----------+----------+-------------------------+-----------------------------------------------------------------------------------------------|
| Alt+P    | macro    | draw outer border       | vnd.sun.star.script:Standard.Module1.PaintBorderBlack?language=Basic&location=application     |
| Alt+B    | macro    | draw outer thick border | vnd.sun.star.script:Standard.Module1.SetOuterBorder?language=Basic&location=application       |
|----------+----------+-------------------------+-----------------------------------------------------------------------------------------------|
