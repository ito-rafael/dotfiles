...
#output $primary   background ~/.config/feh/london.jpg fill
#output $secondary background ~/.config/feh/london.jpg fill
#output $tertiary  background ~/.config/feh/nasa.png fill
#output $laptop background ~/.config/feh/london.jpg fill
#+end_src
** Touchpad
...
exec --no-startup-id "$SCRIPT_PATH/xremap-keeb-config.sh"
#+end_src
#+end_src
