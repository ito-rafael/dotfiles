...
**** Numpad (colemak)
#+begin_src sh
bindsym mod1+r exec "$SCRIPT_PATH/navigate2ws.sh 11"
bindsym mod1+s exec "$SCRIPT_PATH/navigate2ws.sh 12"
bindsym mod1+t exec "$SCRIPT_PATH/navigate2ws.sh 13"
bindsym mod1+w exec "$SCRIPT_PATH/navigate2ws.sh 14"
bindsym mod1+f exec "$SCRIPT_PATH/navigate2ws.sh 15"
bindsym mod1+p exec "$SCRIPT_PATH/navigate2ws.sh 16"
bindsym mod1+x exec "$SCRIPT_PATH/navigate2ws.sh 17"
bindsym mod1+c exec "$SCRIPT_PATH/navigate2ws.sh 18"
bindsym mod1+d exec "$SCRIPT_PATH/navigate2ws.sh 19"
bindsym mod1+space exec "$SCRIPT_PATH/navigate2ws.sh 10"
*** Tertiary monitor
**** Numbers
#+begin_src sh
...
**** Home row (qwerty)
#+begin_src sh :tangle no
bindsym mod5+a exec "$SCRIPT_PATH/navigate2ws.sh 21"
bindsym mod5+s exec "$SCRIPT_PATH/navigate2ws.sh 22"
bindsym mod5+d exec "$SCRIPT_PATH/navigate2ws.sh 23"
bindsym mod5+f exec "$SCRIPT_PATH/navigate2ws.sh 24"
bindsym mod5+g exec "$SCRIPT_PATH/navigate2ws.sh 25"
bindsym mod5+h exec "$SCRIPT_PATH/navigate2ws.sh 26"
bindsym mod5+j exec "$SCRIPT_PATH/navigate2ws.sh 27"
bindsym mod5+k exec "$SCRIPT_PATH/navigate2ws.sh 28"
bindsym mod5+l exec "$SCRIPT_PATH/navigate2ws.sh 29"
bindcode mod5+48 exec "$SCRIPT_PATH/navigate2ws.sh 20"
#+end_src
**** Numpad (qwerty)
#+begin_src sh :tangle no
...
**** Numpad (colemak)
#+begin_src sh
bindsym mod5+r exec "$SCRIPT_PATH/navigate2ws.sh 21"
bindsym mod5+s exec "$SCRIPT_PATH/navigate2ws.sh 22"
bindsym mod5+t exec "$SCRIPT_PATH/navigate2ws.sh 23"
bindsym mod5+w exec "$SCRIPT_PATH/navigate2ws.sh 24"
bindsym mod5+f exec "$SCRIPT_PATH/navigate2ws.sh 25"
bindsym mod5+p exec "$SCRIPT_PATH/navigate2ws.sh 26"
bindsym mod5+x exec "$SCRIPT_PATH/navigate2ws.sh 27"
bindsym mod5+c exec "$SCRIPT_PATH/navigate2ws.sh 28"
bindsym mod5+d exec "$SCRIPT_PATH/navigate2ws.sh 29"
bindsym mod5+space exec "$SCRIPT_PATH/navigate2ws2.sh 20"
