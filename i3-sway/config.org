...
bindsym F16 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh cut
bindsym F17 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh copy
bindsym F18 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh paste
#+end_src
** Applications
#+begin_src conf :noweb-ref keybindings
