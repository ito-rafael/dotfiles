...
bindsym --release $mod+Left  exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus left
bindsym --release $mod+Down  exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus down
bindsym --release $mod+Up    exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus up
bindsym --release $mod+Right exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus right
#+end_src
** Move window
...
bindsym --release mod1+$mod+f exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh fullscreen
bindsym --release Shift+mod1+$mod+f fullscreen toggle
#+end_src
*** Tiling/Floating
...
bindsym --release mod1+$mod+q exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh kill
bindsym --release shift+mod1+$mod+q exec $SCRIPT_PATH/kill-window.sh
#+end_src
** Tangle :noexport:
*** i3
#+begin_src conf :noweb yes :tangle _config_i3
...
bindsym --release mod1+$mod+g exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh new_terminal
...
bindsym --release $mod+m exec $XDG_CONFIG_HOME/scripts/lanmouse-switch.sh
#+end_src
** Tangle :noexport:
*** i3
#+begin_src conf :noweb yes :tangle _config_i3
