...
- [[#scratchpads][Scratchpads]]
  - [[#whatsapp-web-on-brave-beta][WhatsApp Web (on Brave Beta)]]
  - [[#youtube-music-on-brave-beta][YouTube Music (on Brave Beta)]]
  - [[#scrcpy][scrcpy]]
  - [[#python][Python]]
  - [[#terminal-1][Terminal]]
...
for_window [$prop="^brave-web.whatsapp.com__-Default$"] floating enable
for_window [$prop="^brave-web.whatsapp.com__-Default$"] move position center
for_window [$prop="^brave-web.whatsapp.com__-Default$"] move scratchpad
for_window [$prop="^brave-web.whatsapp.com__-Default$"] border pixel 5
exec --no-startup-id brave-beta --app=https://web.whatsapp.com
