...
bindsym --release shift+mod3+Left  exec "$XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus_output left"
bindsym --release Ctrl+$mod+Left   exec "$XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus_output left"
bindsym --release shift+mod3+Right exec "$XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus_output right"
bindsym --release Ctrl+$mod+Right  exec "$XDG_CONFIG_HOME/scripts/sway-dispatch.sh focus_output right"
#+end_src
