...
bindsym XF86AudioRaiseVolume exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+ && ~/.config/eww/volume.sh
bindsym XF86AudioLowerVolume exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && ~/.config/eww/volume.sh
#+end_src
**** Fine
#+begin_src conf :noweb-ref volume
bindsym shift+XF86AudioRaiseVolume exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%- && ~/.config/eww/volume.sh
bindsym shift+XF86AudioLowerVolume exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%- && ~/.config/eww/volume.sh
#+end_src
**** Toggle
#+begin_src conf :noweb-ref volume
bindsym XF86AudioMute exec --no-startup-id wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && ~/.config/eww/volume.sh
#+end_src
** Microphone control
...
#bindsym F14      exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 5%-
#bindsym ctrl+F14 exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 5%+
#+end_src
**** Fine
#+begin_src conf :noweb-ref microphone :tangle no
#bindsym shift+F14      exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 1%-
#bindsym ctrl+shift+F14 exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 1%+
#+end_src
**** Toggle
#+begin_src conf :noweb-ref microphone
bindsym XF86AudioMicMute exec --no-startup-id wpctl set-volume @DEFAULT_AUDIO_SOURCE@ toggle
#+end_src
** Tangle :noexport:
*** i3
#+begin_src conf :noweb yes :tangle _config_i3
