...
bindsym F17 nop
bindsym F18 nop
bindsym --release F16 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh cut
bindsym --release F17 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh copy
bindsym --release F18 exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh paste
#+end_src
** Applications
#+begin_src conf :noweb-ref keybindings
