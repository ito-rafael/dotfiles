...
#+end_src
* +Outputs+
This section was entirely deprecated in favour of =kanshi=.
** +Default Scenario+
...
#+begin_src conf :noweb-ref i3-output-default :tangle no
set $laptop    eDP-1
set $primary   HDMI1
set $secondary VGA1
set $tertiary  HDMI2
#+end_src
**** +Sway+
#+begin_src conf :noweb-ref sway-output-default :tangle no
set $laptop    eDP-1
set $primary   HDMI-A-1
#set $secondary HDMI3
#set $tertiary  VGA1
set $secondary DP-1
set $tertiary DVI-I-1
#+end_src
*** +Set resolution+
**** +i3+
+Outputs in i3wm is now being configured through a script (=xrandr-config.sh=), called in the [[*Startup commands]].+
#+begin_src conf :noweb-ref i3-output-xrandr :tangle no
exec xrandr --output $primary   --mode 1920x1080 --rate 60.00 --brightness 1 --pos 1920x0 --primary
exec xrandr --output $secondary --mode 1920x1080 --rate 60.00 --brightness 1 --pos    0x0
exec xrandr --output $tertiary  --mode 1920x1080 --rate 60.00 --brightness 1 --pos 3840x0 --rotate right
#+end_src
**** +Sway+
#+begin_src conf :noweb-ref sway-output-default :tangle no
output $primary   mode 1920x1080@60hz position 1920,0 scale 1
output $secondary mode 1920x1080@60hz position    0,0 scale 1
output $tertiary  mode 1920x1080@60hz position 3840,0 scale 1 transform 90
#+end_src
** +MSc presentation+
*** +Set order+
#+begin_src comment :tangle no
...
#
#+end_src
#+begin_src conf :noweb-ref sway-output-msc :tangle no
set $laptop    eDP-1
...
#
#+end_src
#+begin_src conf :noweb-ref sway-output-hvb1 :tangle no
set $primary   HDMI-A-1
set $secondary DP-1
set $laptop    eDP-1
#+end_src
...
#
#+end_src
#+begin_src conf :noweb-ref sway-output-hvb2 :tangle no
set $primary   HDMI-A-1
set $secondary DP-1
set $laptop    eDP-1
#+end_src
...
+For HDMI 4K@60Hz:+
#+begin_src conf :noweb-ref sway-output-mirror :tangle no
...
Most of this section was deprecated in favour of =kanshi=. Workspaces name vars are kept here, though.
** +Default output+
*** +Primary output+
#+begin_src conf :noweb-ref ws :tangle no
