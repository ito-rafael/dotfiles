...
for_window [$prop="^Brave-browser-beta$" instance="^web.whatsapp.com$"] \
    floating enable;      \
...
exec --no-startup-id /usr/bin/emacs --with-profile efs --daemon &  # launch EFS daemon (default)
exec --no-startup-id /usr/bin/emacs --with-profile doom --daemon & # launch Doom Emacs daemon
#+end_src
*** Config
#+begin_src conf :noweb-ref daemons
