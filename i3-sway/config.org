...
bindsym $mod+y [$prop="^dropdown_python$"] scratchpad show; [$prop="^dropdown_python$"] move position center
...
bindsym $mod+h [$prop="^dropdown_terminal$"] scratchpad show; [$prop="^dropdown_terminal"] move position center
...
for_window [$prop="^brave-music.youtube.com__-Default$"] opacity 0.9
#+end_src
** Tangle :noexport:
*** i3
#+begin_src conf :noweb yes :tangle _config_i3
