...
#+begin_src conf :tangle no
bindsym ctrl+$mod+a move container to workspace number $ws1; workspace $ws1
bindsym ctrl+$mod+r move container to workspace number $ws2; workspace $ws2
bindsym ctrl+$mod+s move container to workspace number $ws3; workspace $ws3
bindsym ctrl+$mod+t move container to workspace number $ws4; workspace $ws4
bindsym ctrl+$mod+g move container to workspace number $ws5; workspace $ws5
bindsym ctrl+$mod+m move container to workspace number $ws6; workspace $ws6
bindsym ctrl+$mod+n move container to workspace number $ws7; workspace $ws7
bindsym ctrl+$mod+e move container to workspace number $ws8; workspace $ws8
bindsym ctrl+$mod+i move container to workspace number $ws9; workspace $ws9
bindsym ctrl+$mod+o move container to workspace number $ws0; workspace $ws0
#+end_src
**** Upper row (colemak)
#+begin_src conf :tangle no
bindsym $mod+q move container to workspace number $ws1; workspace $ws1
bindsym $mod+w move container to workspace number $ws2; workspace $ws2
bindsym $mod+f move container to workspace number $ws3; workspace $ws3
bindsym $mod+p move container to workspace number $ws4; workspace $ws4
bindsym $mod+b move container to workspace number $ws5; workspace $ws5
bindsym $mod+j move container to workspace number $ws6; workspace $ws6
bindsym $mod+l move container to workspace number $ws7; workspace $ws7
bindsym $mod+u move container to workspace number $ws8; workspace $ws8
bindsym $mod+y move container to workspace number $ws9; workspace $ws9
bindcode $mod+48 move container to workspace number $ws0; workspace $ws0
#+end_src
**** Numpad (colemak)
#+begin_src conf :tangle no
bindsym ctrl+$mod+r move container to workspace number $ws1; workspace $ws1
bindsym ctrl+$mod+s move container to workspace number $ws2; workspace $ws2
bindsym ctrl+$mod+t move container to workspace number $ws3; workspace $ws3
bindsym ctrl+$mod+w move container to workspace number $ws4; workspace $ws4
bindsym ctrl+$mod+f move container to workspace number $ws5; workspace $ws5
bindsym ctrl+$mod+p move container to workspace number $ws6; workspace $ws6
bindsym ctrl+$mod+x move container to workspace number $ws7; workspace $ws7
bindsym ctrl+$mod+c move container to workspace number $ws8; workspace $ws8
bindsym ctrl+$mod+d move container to workspace number $ws9; workspace $ws9
bindsym ctrl+$mod+space move container to workspace number $ws0; workspace $ws0
#+end_src
*** Secondary monitor
**** Numbers
...
#+begin_src conf :tangle no
bindsym shift+ctrl+$mod+a move container to workspace number $ws11; workspace $ws11
bindsym shift+ctrl+$mod+r move container to workspace number $ws12; workspace $ws12
bindsym shift+ctrl+$mod+s move container to workspace number $ws13; workspace $ws13
bindsym shift+ctrl+$mod+t move container to workspace number $ws14; workspace $ws14
bindsym shift+ctrl+$mod+g move container to workspace number $ws15; workspace $ws15
bindsym shift+ctrl+$mod+m move container to workspace number $ws16; workspace $ws16
bindsym shift+ctrl+$mod+n move container to workspace number $ws17; workspace $ws17
bindsym shift+ctrl+$mod+e move container to workspace number $ws18; workspace $ws18
bindsym shift+ctrl+$mod+i move container to workspace number $ws19; workspace $ws19
bindsym shift+ctrl+$mod+o move container to workspace number $ws10; workspace $ws10
#+end_src
**** Upper row (colemak)
#+begin_src conf :tangle no
bindsym ctrl+$mod+q move container to workspace number $ws11; workspace $ws11
bindsym ctrl+$mod+w move container to workspace number $ws12; workspace $ws12
bindsym ctrl+$mod+f move container to workspace number $ws13; workspace $ws13
bindsym ctrl+$mod+p move container to workspace number $ws14; workspace $ws14
bindsym ctrl+$mod+b move container to workspace number $ws15; workspace $ws15
bindsym ctrl+$mod+j move container to workspace number $ws16; workspace $ws16
bindsym ctrl+$mod+l move container to workspace number $ws17; workspace $ws17
bindsym ctrl+$mod+u move container to workspace number $ws18; workspace $ws18
bindsym ctrl+$mod+y move container to workspace number $ws19; workspace $ws19
bindcode ctrl+$mod+48 move container to workspace number $ws10; workspace $ws10
#+end_src
**** Numpad (colemak)
#+begin_src conf :tangle no
bindsym shift+ctrl+$mod+r move container to workspace number $ws11; workspace $ws11
bindsym shift+ctrl+$mod+s move container to workspace number $ws12; workspace $ws12
bindsym shift+ctrl+$mod+t move container to workspace number $ws13; workspace $ws13
bindsym shift+ctrl+$mod+w move container to workspace number $ws14; workspace $ws14
bindsym shift+ctrl+$mod+f move container to workspace number $ws15; workspace $ws15
bindsym shift+ctrl+$mod+p move container to workspace number $ws16; workspace $ws16
bindsym shift+ctrl+$mod+x move container to workspace number $ws17; workspace $ws17
bindsym shift+ctrl+$mod+c move container to workspace number $ws18; workspace $ws18
bindsym shift+ctrl+$mod+d move container to workspace number $ws19; workspace $ws19
bindsym shift+ctrl+$mod+space move container to workspace number $ws10; workspace $ws10
#+end_src
*** Tertiary monitor
**** Numbers
...
#+begin_src conf :tangle no
bindsym ctrl+mod3+a move container to workspace number $ws20; workspace $ws20
bindsym ctrl+mod3+r move container to workspace number $ws21; workspace $ws21
bindsym ctrl+mod3+s move container to workspace number $ws22; workspace $ws22
bindsym ctrl+mod3+t move container to workspace number $ws23; workspace $ws23
bindsym ctrl+mod3+g move container to workspace number $ws24; workspace $ws24
bindsym ctrl+mod3+m move container to workspace number $ws25; workspace $ws25
bindsym ctrl+mod3+n move container to workspace number $ws26; workspace $ws26
bindsym ctrl+mod3+e move container to workspace number $ws27; workspace $ws27
bindsym ctrl+mod3+i move container to workspace number $ws28; workspace $ws28
bindsym ctrl+mod3+o move container to workspace number $ws29; workspace $ws29
#+end_src
**** Upper row (colemak)
#+begin_src conf :tangle no
bindsym mod3+q move container to workspace number $ws20; workspace $ws20
bindsym mod3+w move container to workspace number $ws21; workspace $ws21
bindsym mod3+f move container to workspace number $ws22; workspace $ws22
bindsym mod3+p move container to workspace number $ws23; workspace $ws23
bindsym mod3+b move container to workspace number $ws24; workspace $ws24
bindsym mod3+j move container to workspace number $ws25; workspace $ws25
bindsym mod3+l move container to workspace number $ws26; workspace $ws26
bindsym mod3+u move container to workspace number $ws27; workspace $ws27
bindsym mod3+y move container to workspace number $ws28; workspace $ws28
bindcode mod3+48 move container to workspace number $ws29; workspace $ws29
#+end_src
**** Numpad (colemak)
#+begin_src conf :tangle no
bindsym ctrl+mod3+r move container to workspace number $ws20; workspace $ws20
bindsym ctrl+mod3+s move container to workspace number $ws21; workspace $ws21
bindsym ctrl+mod3+t move container to workspace number $ws22; workspace $ws22
bindsym ctrl+mod3+w move container to workspace number $ws23; workspace $ws23
bindsym ctrl+mod3+f move container to workspace number $ws24; workspace $ws24
bindsym ctrl+mod3+p move container to workspace number $ws25; workspace $ws25
bindsym ctrl+mod3+x move container to workspace number $ws26; workspace $ws26
bindsym ctrl+mod3+c move container to workspace number $ws27; workspace $ws27
bindsym ctrl+mod3+d move container to workspace number $ws28; workspace $ws28
bindsym ctrl+mod3+space move container to workspace number $ws29; workspace $ws29
#+end_src
#+begin_src conf
