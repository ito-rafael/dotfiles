...
bindsym $mod+j exec "$SCRIPT_PATH/scratchpad.sh dropdown_python 0.6 0.6"
...
bindsym $mod+m exec "$SCRIPT_PATH/scratchpad.sh dropdown_terminal 0.75 0.75"
...
bindsym $mod+k exec "$SCRIPT_PATH/scratchpad.sh keymapp 0.75 0.75"
...
bindsym $mod+b exec "$SCRIPT_PATH/scratchpad_temp.sh show"
bindsym ctrl+$mod+b exec "$SCRIPT_PATH/scratchpad_temp.sh destroy"
#+end_src
** YouTube Music (on Brave)
*** i3
#+begin_src conf :noweb-ref i3-yt-music
exec --no-startup-id brave-beta --app=https://music.youtube.com
bindsym $mod+g exec "$SCRIPT_PATH/scratchpad.sh "Brave-browser-beta" 0.9 0.9"
