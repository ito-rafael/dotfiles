...
| Mod4     | Super_L                        |
|----------+--------------------------------|
#+begin_src conf :noweb-ref header
set $alt Mod1
set $mod Mod4
set $super_R Mod3
#+end_src
...
#+begin_src conf :noweb-ref sway-common
input type:touchpad {
...
#+end_src
** papersway
#+begin_src conf :noweb-ref papersway
focus_wrapping no
default_orientation horizontal
workspace_layout default

bindsym $alt+ctrl+comma workspace 55
#+end_src
** scroll
#+begin_src conf :noweb-ref scroll
maximize_if_single true
cursor_shake_magnify true
workspace_next_on_output_create_empty false

# eye-candy
default_decoration border_radius 20

# animations
animations {
    enabled yes
    style scale
    default       yes       350            var simple      [ 0.16 1.0 0.3 1.0 ]
    window_open   yes       300            var simple      [ 0.0  0.0 1.0 1.0 ]
    window_move   yes       300            var simple      [ 0.21 0.6 0.35 1.0 ]
    window_size   yes       300            var simple      [ 0.0 0.0 0.0 0.5 ]
}
#+end_src
* Workspaces
** WS names (icons)
...
* Media control
** Playerctl
#+begin_src conf :noweb-ref i3bang-common
...
**** Coarse
#+begin_src conf :noweb-ref i3bang-common :tangle no
...
*** Current window
#+begin_src conf :noweb-ref i3bang-i3
#+end_src
*** All windows
#+begin_src conf :noweb-ref i3bang-i3
#+end_src
...
*** Current window
#+begin_src conf :noweb-ref i3bang-sway :tangle no
...
#+end_src
*** Sway
#+begin_src conf :noweb-ref i3bang-sway
...
| kp6 | right           |
|-----+-----------------|
#+begin_src conf :noweb-ref i3bang-i3 :tangle no
bindsym kp_4 <TBD>
bindsym kp_2 <TBD>
bindsym kp_8 <TBD>
bindsym kp_6 <TBD>
...
#+begin_src conf :noweb-ref post-i3
...
*** Sway
**** Locker & messanger
#+begin_src conf :noweb-ref post-sway
...
*** Mode
#+begin_src conf :noweb-ref post-common
mode "resize" {
    #=============================
    # fine control
    #=============================
...
*** Mode
#+begin_src conf :noweb-ref post-common :tangle no
...
mode "$mode_acute" {
    ...
    bindsym v       exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh type "'v", mode "default"
    # misc uppercase
    ...
    bindsym Shift+v exec $XDG_CONFIG_HOME/scripts/sway-dispatch.sh type "'V", mode "default"
    # escape
    bindsym Escape mode "default"
    bindsym Return mode "default"
    #-----------------------------
...
#+end_src
*** Emacs
#+begin_src conf :noweb-ref post-sway :tangle no
...
bindsym $alt+$mod+s exec "$SCRIPT_PATH/show-or-launch.sh translate.google.com 0.6 0.9"
#+end_src
*** Sway
#+begin_src conf :noweb-ref post-sway
...
#+end_src
*** SwayFX
#+begin_src conf :noweb yes :tangle _config_swayfx
<<header>>
<<sway-common>>
<<swayfx>>
<<i3bang-begin>>
...
#+end_src
*** papersway
#+begin_src conf :noweb yes :tangle _config_papersway
<<header>>
<<sway-common>>
<<papersway>>
<<i3bang-begin>>
...
#+end_src
*** scroll
#+begin_src conf :noweb yes :tangle _config_scroll
<<header>>
<<sway-common>>
<<scroll>>
<<i3bang-begin>>
